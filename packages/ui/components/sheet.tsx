    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          size === "wide" &&
            "data-[side=left]:!w-[min(48rem,calc(100vw-2rem))] data-[side=left]:sm:!max-w-3xl data-[side=right]:!w-[min(48rem,calc(100vw-2rem))] data-[side=right]:sm:!max-w-3xl",
          className
        )}
        {...props}
      >
...
function SheetFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("mt-auto flex gap-2 px-4 py-3", className)}
      {...props}
    />
  )
}

...
function Tabs({
  ...
  return (
    <TabsPrimitive.Root
      ...
      className={cn("group/tabs flex min-w-0 max-w-full gap-2 data-horizontal:flex-col", className)}
      {...props}
    />
  )
}
...
const tabsListVariants = cva(
  "group/tabs-list no-scrollbar inline-flex max-w-full w-fit items-center justify-center overflow-x-auto overscroll-x-contain rounded-lg p-[3px] text-muted-foreground group-data-horizontal/tabs:h-8 group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col data-[variant=line]:w-full data-[variant=line]:justify-start data-[variant=line]:rounded-none",
  {
    variants: {
      variant: {
        default: "bg-muted",
